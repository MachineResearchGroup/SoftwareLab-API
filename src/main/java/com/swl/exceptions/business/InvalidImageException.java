...
public class InvalidImageException extends BaseRuntimeException {
    private static final String KEY = "invalid.image";

    public InvalidImageException(String value) {
        super(Map.of("value", value));
    }

    public InvalidImageException(Class<?> typeClass) {
        super(Map.of("value", typeClass.getSimpleName()));
    }

    public InvalidImageException(ErrorResponse errorResponse) {
