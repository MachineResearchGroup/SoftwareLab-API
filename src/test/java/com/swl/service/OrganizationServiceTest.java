...
public class OrganizationServiceTest {
    ...
    public void registerOrganization_Sucessfully() {
        Collaborator collaborator = BuilderUtil.buildColaborador();
        ...
        Assertions.assertEquals(response.getBody(), new MessageResponse(MessageEnum.REGISTERED, organization));
    }
